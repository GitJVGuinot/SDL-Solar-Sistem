...
int Entity::init(SDL_Color color, bool fill, int res, MV::Pnt3 escala, MV::Pnt3 desp, MV::Pnt3 rot, MV::Pnt3 orbita, MV::Pnt3 centro_orbita)
{
  if (res > 50)
    return 1;
